					...
					ApplicationContext ctx = WebApplicationContextUtils.getWebApplicationContext(getServletContext());    
  					...
  					vml = (List<Vehicle>) CollectionUtils.select(vml,new Predicate(){
  						...
  						public boolean evaluate(Object o){
  							Vehicle v = (Vehicle) o;
  							if(v.getMoneyCountor()==null||v.getMoneyCountor().isEmpty()){
  								return true;
  							}
  							return false;
  						}
        ...
        <table class="table table-condensed">
            ...
            <tr>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field">
                            <input class="input" name="vehicle.moneyCountor" data-validate="required:必填"/>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field">
                            <input class="input" name="vehicle.twiceSupplyDate" data-validate="required:必填"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field">
                            <input class="input datepick" name="vehicle.nextSupplyDate" data-validate="required:必填"/>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field" >
                            <input class="input" name="vehicle.moneyCountorTime" data-validate="required:必填"/>
                        </div>
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field" >
                            <input class="input datepick" name="vehicle.moneyCountorNextDate" data-validate="required:必填"/>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
					...
					<input type="hidden" name="vehicle.operateCardRegister" value="<%=((User)session.getAttribute("user")).getUid()%>"/>
                        </div>
                    </div>
                </td>
            </tr>
