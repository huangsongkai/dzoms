      ...
      <table class="table">
          ...
          <tr>
              <td>
                  <div class="form-group">
                      ...
                      <div class="field">
                      	<s:textfield  class="input" value="%{@com.dz.common.other.ObjectAccess@getObject('com.dz.module.user.User',vehicle.licenseRegister).uname}" />
                      </div>
                  </div>
              </td>
          </tr>
          <tr>
              <td> <div class="form-group">
                  ...
                  <div class="field">
                  	<s:textfield cssClass="input" readonly="readonly" name="vehicle.licenseRegistTime" />
                  </div>
              </div>
