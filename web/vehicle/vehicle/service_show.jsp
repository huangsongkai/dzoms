            ...
            <tr>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field">
                            <s:textfield cssClass="input" name="vehicle.businessLicenseNum" />
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field">
                            <s:textfield cssClass="input" name="vehicle.moneyCountor"/>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field">
                            <s:textfield cssClass="input" name="vehicle.twiceSupplyDate" />
                        </div>
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field">
                            <s:textfield cssClass="input datepick" name="vehicle.nextSupplyDate"/>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field" >
                            <s:textfield cssClass="input" name="vehicle.moneyCountorTime" />
                        </div>
                    </div>
                </td>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field" >
                            <s:textfield cssClass="input" name="vehicle.moneyCountorNextDate"/>
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field">
                        	<s:textfield  class="input" value="%{@com.dz.common.other.ObjectAccess@getObject('com.dz.module.user.User',vehicle.operateCardRegister).uname}" />
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="form-group">
                        ...
                        <div class="field">
                        	<s:textfield cssClass="input" readonly="readonly" name="vehicle.operateCardRegistDate" />
                        </div>
                    </div>
                </td>
            </tr>
