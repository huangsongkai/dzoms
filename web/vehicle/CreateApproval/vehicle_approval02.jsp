    ...
    <form action="vehicleApprovalUpdate" method="post"
            ...
            <tr>
                ...
                <td>
                    <div class="form-group">
                        ...
                        <div class="field">
                            <s:textfield id="oldLicenseNum" cssClass="input" readonly="true" value="%{contract.carNumOld}"/>
                        </div>
                    </div>
                </td>
                <td>
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="tableleft">
                                    <s:textfield id="operateApplyDate" name="vehicleApproval.operateApplyDate" cssClass="input input-auto " size="10"  readonly="true"/>
                                </td>
                                <td>
        ...
        <div>
            ...
            <div class="form-group" style="width: 320px;">
                ...
                <div class="field form-not-disabled">
                    <s:textfield cssClass="input input-auto" data-validate="required:必填,plusdouble:只能填写数字" id="onetimeAfterpay" name="vehicleApproval.onetimeAfterpay"></s:textfield>元
                </div>
            </div>
            </s:if>
<s:if test="%{contract.contractFrom!=null}">
				...
				<tr>
					<td>
						<div class="form-group">
			                ...
			                <div class="field form-not-disabled">
			                    <s:textfield id="onetimeAfterpay" name="vehicleApproval.onetimeAfterpay" data-validate="required:必填,plusdouble:只能填写数字" cssClass="input"/>
			                </div>
                         </div>
					</td>
					<td>
						<div class="form-group">
			                ...
			                <div class="field  form-not-disabled">
			                    <s:textfield id="payBeginDate" name="vehicleApproval.payBeginDate" data-validate="required:必填" cssClass="input datepick"/>
			                </div>
			            </div>
					</td>
					<td>
						<div class="form-group">
			                ...
			                <div class="field  form-not-disabled">
			                    <s:textfield id="payEndDate" name="vehicleApproval.payEndDate" data-validate="required:必填" cssClass="input datepick"/>
			                </div>
                         </div>
					</td>
				</tr>
        ...
        <blockquote class="border-main" style="display: none;">
