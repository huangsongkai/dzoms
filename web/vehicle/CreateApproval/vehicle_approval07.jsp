...
<s:radio name="vehicleApproval.ascription" list="%{#{'false':'公司','true':'个人'}}"/>
        ...
        <blockquote class="form-disabled">
            ...
            <div>
            	<s:if test="%{contract.contractFrom==null}">
            	<!--优惠天数：--><s:textfield name="vehicleApproval.discountDays" value="3" cssStyle="display: none;"></s:textfield>
                </s:if>
        ...
        <div class="xm7-move">
        	<input type="button" value="同意" class="button bg-green" onclick="approvalApply('#officeRemark');">
