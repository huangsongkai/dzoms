...
<s:radio name="vehicleApproval.ascription" list="%{#{'false':'公司','true':'个人'}}"/>
        ...
        <blockquote class="form-disabled">
            <strong>承租人申请：</strong>
            <div>
                <s:textarea name="contract.driverRequest" class="input-xlarge"
        ...
        <blockquote class="form-disabled">
            ...
            <div>
                <s:textarea
                        ...
                        name="vehicleApproval.branchManagerRemark" class="input-xlarge"
        ...
        <blockquote class="form-disabled" style="display: none;">
            ...
            <div>
                <s:textarea id="assurerRemark"
                            name="vehicleApproval.assurerRemark" class="input-xlarge"
                            rows="3" cssStyle="width:100%">
        ...
        <blockquote class="form-disabled">
            ...
            <div>
                <s:textarea id="managerRemark"
                            name="vehicleApproval.managerRemark" class="input-xlarge"
                            rows="3" cssStyle="width:100%">
        ...
        <blockquote class="form-disabled">
            ...
            <div>
                <s:textarea
                        ...
                        name="vehicleApproval.financeManagerRemark" class="input-xlarge"
                        rows="3" cssStyle="width:100%">
        ...
        <blockquote class="form-disabled">
            ...
            <div>
                <s:textarea
                        id="financeRemark"
                        name="vehicleApproval.financeRemark" class="input-xlarge"
                        rows="3" cssStyle="width:100%">
        ...
        <blockquote class="form-disabled">
            ...
            <div>
                ...
                <s:textarea id="directorRemark"
                            name="vehicleApproval.directorRemark" class="input-xlarge"
                            rows="3" cssStyle="width:100%">
        ...
        <blockquote class="border-main">
            ...
            <div>
                <s:textarea id="officeRemark"
                            name="vehicleApproval.officeRemark" class="input-xlarge"
                            rows="3" cssStyle="width:100%">
                </s:textarea>
            </div>
        </blockquote>
