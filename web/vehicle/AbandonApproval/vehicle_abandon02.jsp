...
<body>
	...
	<div class="adminmin-bread">
		...
		<form name="vehicleApprovalUpdate" action="/DZOMS/vehicle/vehicleApprovalUpdate" method="post"
			...
			<table class="table table-bordered table-hover m10">
				...
				<tr>
					...
					<td >
					<s:textfield name="contract.abandonReason" readonly="readonly" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3" style="text-align:right;">
						<input type="button" value="同意" class="btn btn-primary" onclick="approvalApply('#assurerRemark');">
