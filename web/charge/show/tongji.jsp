...
<div class="line">
  ...
  <div class="panel margin-small" >
      ...
      <div class="form-group">
        ...
        <div class="field">
          <s:select name="status" cssClass="input" list="#{0:'欠费',1:'正常',2:'未交',3:'已交'}" value="%{status}">
          </s:select>
        </div>
      </div>
...
<form action="/DZOMS/charge/tongji" method="post" id="formx">
    <s:hidden value="%{department}" name="department"/>
    <s:hidden value="%{time}" name="time"/>
    <s:hidden value="%{status}" name="status"/>
