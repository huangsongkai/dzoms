       ...
       <s:set name="d" value="%{@com.dz.common.other.ObjectAccess@getObject('com.dz.module.driver.Driver',complain.dealReault)}"></s:set>
             <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0"> 
                ...
                <tr>
                    ...
                    <td  colspan="7"><div align="center"><s:property value="%{complain.state>0?'属实':'不属实'}"/></div></td>
                </tr>
                <tr>
                    <td ><div align="center">
                      <p>&nbsp;</p>
                    ...
                    <td  colspan="7"><div align="center">
                      <p>&nbsp;</p>
                      <p><s:property value="%{complain.visitBackResult}"/>
                      </p><p>&nbsp;</p>
                    </div></td>
                </tr>
                <tr>
                    ...
                    <td colspan="5"><div align="center"><s:date name="%{complain.finishTime}" format="yyyy/MM/dd HH:mm:ss"/></div></td>
                    <td ><div align="center">
                      <p>&nbsp;</p>
                      <p>办理人</p>
                      <p>&nbsp;</p>
                    </div></td>
                    <td ><div align="center"><s:property value="%{@com.dz.common.other.ObjectAccess@getObject('com.dz.module.user.User',complain.finishPerson).uname}"/></div></td>
                </tr>
