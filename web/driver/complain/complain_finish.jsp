...
<body>
    ...
    <form name="finishComplain" action="/DZOMS/driver/complain/handledComplain" method="post">
            ...
            <table class="table table-hover">
               ...
               <tr>
                ...
                <tr>
                    ...
                    <input type="hidden" name="complain.finishPerson" value="<%=((User)session.getAttribute("user")).getUid()%>"/></td>
                        
                    <td colspan="3"></td>
                    <td>完结时间</td>
                    <td><input  class="datetimepicker input" name="complain.finishTime" value="<%=(new  java.text.SimpleDateFormat("yyyy/MM/dd")).format(new java.util.Date()) %>"/></td>
                </tr>
                <tr>
