...
<body>
    ...
    <form name="visitBackComplain" action="/DZOMS/driver/complain/visitBackComplain" method="post">
            ...
            <table class="table table-hover">
               ...
               <tr>
                ...
                <tr>
                    ...
                    <input type="hidden" name="complain.visitBackPerson" value="<%=((User)session.getAttribute("user")).getUid()%>"/></td>

                    <td colspan="3"></td>
                    <td>回访时间</td>
                    <td><input  class="datetimepicker input" name="complain.visitBackTime" value="<%=(new  java.text.SimpleDateFormat("yyyy/MM/dd")).format(new java.util.Date()) %>"/></td>
                </tr>
                <tr>
