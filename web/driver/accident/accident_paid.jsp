...
<head>
    ...
    <script>
        ...
        function setRegister(userId){
            dat = {"className":"com.dz.module.user.User","id":userId,"isString":false};
...
<form action="/DZOMS/accident_Paied" method="post" id="form">
<blockquote class="border-main">
    ...
    <div class="container">
        <table class="table" style="width: auto">
            ...
            <tr>
                <td class="tableleft">赔付人</td>
                <td><input class="input" type="text" name="pay.payer"></td>
                <td>赔付时间</td>
                <td><input class="datetimepicker input" type="text" name="pay.time" id="tt"></td>
                <td>陪付金额</td>
                <td><input type="text" name="pay.money" placeholder="(元)" class="input"/></td>
                 <td> <div class="form-button"><input class="button bg-green" value="赔付" onclick="dosubmit()" type="button"></input></div></td>
            </tr>
