    		 ...
    		 <div class="panel-body">
    		  ...
    		  <div class="line">
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input class="input input-auto" size="20" id="carLoss" name="loss.carLoss" onblur="addLoss()" value="<%=accident==null?0:(accident.getCarLoss()==null?0:accident.getCarLoss())%>">
                    </div>
                </div>
                <div class="form-group">
                    <div class="label padding">
    		  		    ...
    		  		    <div class="line">
									...
									<div class="line">
										  <div class="form-group">
										  	...
										  	<div class="field">
										  		  <input class="input input-auto" size="40" name="loss.peopleLoss" id="peopleLoss" onblur="addLoss();" value="<%=accident==null?0:(accident.getPeopleLoss()==null?0:accident.getPeopleLoss())%>">
										  	</div>
