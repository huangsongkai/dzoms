...
var _css3 = __webpack_require__(46);
...
var _css6 = __webpack_require__(33);

var _datePicker = __webpack_require__(32);

var _datePicker2 = _interopRequireDefault(_datePicker);

var _css7 = __webpack_require__(30);
    ...
    value: function render() {
      ...
      var columns = [{
        ...
        children: [{
          ...
          dataIndex: "bumen",
          render: function render(text, record, index) {
            return _react2.default.createElement(_inputNumber2.default, { min: 1, max: maxValue[index], defaultValue: 0, disabled: !(_this2.props.department == "bumen"), onChange: _this2.onScoreChange.bind(_this2, index) });
          }
        }, {
          title: "考评组",
          dataIndex: "pfgroup"
    ...
    value: function render() {
      ...
      var columns = [{
        ...
        children: [{
          ...
          dataIndex: "pfgroup",
          render: function render(text, record, index) {
            return _react2.default.createElement(_inputNumber2.default, { min: 1, max: maxValue[index], defaultValue: _this2.props.department == "historykp" ? recKpGroup[index] : "", disabled: _this2.props.department == "historykp" ? true : false, onChange: _this2.onScoreChange.bind(_this2, index) });
          }
        }]
      }];
      // (key)=>this.spToInput.bind(this,key)
...
var _Sorter = __webpack_require__(40);
...
var _PureRenderMixin = __webpack_require__(69);
...
var _rcTrigger = __webpack_require__(119);
...
var _css4 = __webpack_require__(46);
    ...
    value: function render() {
      ...
      var columns = [{
        ...
        children: [{
          ...
          dataIndex: "score",
          render: function render(text, record, index) {
            return _react3.default.createElement(_inputNumber2.default, { min: 1, max: maxValue[index], defaultValue: 0, onChange: _this3.onScoreChange.bind(_this3, index) });
          }
        }, {
          title: "部门",
          dataIndex: "bumen"
