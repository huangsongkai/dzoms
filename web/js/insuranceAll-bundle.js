...
var _css3 = __webpack_require__(99);
...
var _css2 = __webpack_require__(490);
...
var _carNumber = __webpack_require__(529);
...
var Filters = function () {
  ...
  _createClass(Filters, [{
    key: "filter",
    value: function filter(recData) {
      var filterData = {}; //要进行筛选的数据
      if (recData) {
        recData.map(function (item) {
          for (var key in item) {
            if (filterData[key]) {
    ...
    _createClass(CarNumber, [{
        ...
        value: function render() {
            return _react3.default.createElement(
                ...
                _react3.default.createElement(
                    _select2.default,
                    { style: { width: '20%' }, placeholder: '\u8F66\u724C\u5F52\u5C5E\u5730', onChange: this.chepaihaoChange.bind(this) },
                    _react3.default.createElement(
                        Option,
                        { value: '\u9ED1A' },
                        '\u9ED1A'
