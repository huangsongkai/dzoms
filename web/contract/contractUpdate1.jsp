...
<m:permission role="合同新增,合同修改权限" any="true">
...
<div class="padding">
    <form method="post" action="/DZOMS/contract/contractUpdate1" class="form-inline" style="width: 100%">
        <s:hidden name="contract.id"></s:hidden>
        <s:hidden name="contract.state"></s:hidden>
