							...
							<div class="block-content">
								<table class="table" id="wait_deal" style="font-size: larger;">
									...
									<tr>
										...
										%>
										<td><s:property value="%{@com.dz.common.other.ObjectAccess@execute(#request.new_car_approve_hql)}"/></td>
									</tr>
									...
									<tr>
										...
										%>
										<td><s:property value="%{@com.dz.common.other.ObjectAccess@execute(#request.re_car_approve_hql)}"/></td>
									</tr>
									<tr>
										<td>废业办理</td>
										<%
										...
										%>
										<td><s:property value="%{@com.dz.common.other.ObjectAccess@execute(#request.dis_car_approve_hql)}"/></td>
							...
							<div class="block-content">
								<table class="table" id="wait_deal" style="font-size: larger;">
									...
									<tr>
										...
										%>
										<td><s:property value="%{@com.dz.common.other.ObjectAccess@execute(#request.abandoned_car_a_month_hql)}"/></td>
										<td>待处理</td>
										<%
										 ...
										 %>
										<td><s:property value="%{@com.dz.common.other.ObjectAccess@execute(#request.abandoned_car_a_month_wait_deal_hql)}"/></td>
									</tr>
									<tr>
										<td>服务投诉</td>
										<%
										 ...
										 %>
										<td><s:property value="%{@com.dz.common.other.ObjectAccess@execute(#request.complain_count_hql)}"/></td>
										<td>待处理</td>
										<%
										 ...
										 %>
										<td><s:property value="%{@com.dz.common.other.ObjectAccess@execute(#request.complain_count_wait_deal_hql)}"/></td>
									</tr>
									<tr>
										<td>交通事故</td>
										<%
										 ...
										 %>
										<td><s:property value="%{@com.dz.common.other.ObjectAccess@execute(#request.accident_count_hql)}"/></td>
										<td>电子违章</td>
										<%
