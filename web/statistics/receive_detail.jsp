	...
	<div class="margin-big-bottom">
		...
		<div class="line" style="height: 300px; overflow:auto">
			<table class="table table-hover table-striped table-bordered">
				<thead>
				<tr>
					<th>部门</th><th>车号</th><th>调费类型</th><th>金额</th><th>调费时间</th><th>生效月份</th><th>操作人员</th><th>备注</th>
				</tr>
				</thead>
				<tbody>
...
%>
				...
				<td><s:property value="%{#v.time}"/></td>
				<td><s:property value="%{@com.dz.common.other.ObjectAccess@getObject('com.dz.module.user.User',#v.register).uname}"/></td>
