...
public class ObjectAccess extends BaseAction {
	...
	@SuppressWarnings("unchecked")
	private static <T> T executeSingle(String hql,Session session) throws HibernateException{
		Query query = session.createQuery(hql);
	...
	public String select(){
        ...
        long count = ObjectAccess.execute("select count(*) from "+className+" where " + hql);
        ...
        try {
			List<?> l = ObjectAccess.query(Class.forName(className), hql, null, null, null, page);
